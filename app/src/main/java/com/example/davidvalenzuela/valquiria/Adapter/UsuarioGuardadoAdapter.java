...
public class UsuarioGuardadoAdapter extends ArrayAdapter<Usuario>  {

    Context context;
    List<Usuario> objects;


    public UsuarioGuardadoAdapter(Context context, int resource, List<Usuario> objects) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        View view = inflater.inflate(R.layout.usuario_listado_item, null);
